...
<div class="page-header">
	...
	<div class="row">
		<div class="col-lg-8 offset-lg-2">			
			...
			<form role="form" method="post" action="{{ url('addEmployee') }}" class="" enctype="multipart/form-data">
				{{ csrf_field() }}
			...
			<div class="card padall30 mrb30">
                ...
                <div class="form-group row">
                    <div class="col-lg-6">
                        <label for="username">Username</label>
                        <input type="text" class="form-control" name="username" aria-describedby="username" value="{{ auth()->user()->username }}" disabled="disabled" />
                    </div>
                    <div class="col-lg-6"></div>
                </div>
				@endif
				...
				<input type="hidden" id="status" name="status" value="{{ old('status', (isset($row)) ? $row->status : '0') }}"/>
			</div>
                    ...
                    <div class="card">
                        <div class="card-header" id="headingOne">
                            <h4 class="accordian-title" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                <span class="align-left">Bank Details</span>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-6">
                                            <label for="type">Type</label>
                                             <select name="license_type[]" class="form-control license_type">
