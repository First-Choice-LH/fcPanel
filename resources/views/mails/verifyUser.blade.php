                                                                              ...
                                                                              <td valign="top" align="center" class="specbundle">
                                                                                 <div class="contentEditableContainer contentTextEditable">
                                                                                    <div class="contentEditable">
                                                                                       <p style='text-align:left;margin:0;font-family:Georgia,Time,sans-serif;font-size:26px;color:#DC2828;line-height: 32px;'><span class="specbundle2"><span class="font1">Welcome to First Choice Labour Hire – Timesheets</span></span></p>
                                                                                    </div>
                                                                                 </div>
                                                                              </td>
                                                                           </tr>
                                                                  ...
                                                                  <table>
                                                                     <tr>
                                                                        <td align='center' bgcolor='#1A54BA' style='background:#DC2828; padding:15px 18px;-webkit-border-radius: 4px; -moz-border-radius: 4px; border-radius: 4px;'>
                                                                           <div class="contentEditableContainer contentTextEditable">
                                                                              <div class="contentEditable" align='center'>
                                                                                 <a target='_blank' href="{{url('user/verify', $parameters['accessToken'])}}" class='link2' style='color:#ffffff;'>Activate your Account</a>
                                                                              </div>
                                                                           </div>
                                                                        </td>
                                                                     </tr>
