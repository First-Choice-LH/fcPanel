			...
			<table class="table table-hover table-bordered sortable_table">
				<thead class="thead-dark">
					<tr>
						...
						<th scope="col" class="d-none d-md-table-cell d-lg-table-cell" data-col="name">Name</th>
						<th scope="col" class="" data-col="email">Email</th>
						<th scope="col" class="" data-col="role">Role</th>
			  	...
			  	<tbody>
			  		...
			  		<tr>
			  			...
			  			<td class="d-none d-md-table-cell d-lg-table-cell">{{ $row->name }}</td>
			  			<td class="">{{ $row->email }}</td>
			  			<td class="">{{ ucfirst($row->roles[0]->name) }}</td>
