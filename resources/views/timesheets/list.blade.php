            ...
            <div class="table-responsive">
                ...
                <table class="table table-hover table-bordered sortable_table">
                        ...
                        <tr>
                            ...
                            <th scope="col" class="" data-col="title">Jobsite</th>
                            <th scope="col" class="">DateStamp</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td scope="row" class=""><?php echo $i++;  ?></td>
                            ...
                            <td scope="row" class=""><a href="/timesheets/{{ $row->id }}/{{ $row->jobsite_id }}" target="_blank" class="btn btnbg btnbig">View Timesheet</a></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
